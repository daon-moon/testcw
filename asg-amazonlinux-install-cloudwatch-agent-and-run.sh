...
wget https://raw.githubusercontent.com/daon-moon/testcw/master/amazon-cloudwatch-asg-amazonlinux.json
#aws s3 cp s3://hmx-cloudop-fileshare-01/cloudwatch-agent-config/amazon-cloudwatch-agent-mem-linux.json /home/ec2-user/

sleep 5

sudo cp /home/ec2-user/amazon-cloudwatch-asg-amazonlinux.json /opt/aws/amazon-cloudwatch-agent/etc/amazon-cloudwatch-agent-linux.json
